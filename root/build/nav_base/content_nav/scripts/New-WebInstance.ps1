...
#Copy-Item 'C:\scripts\_SHARE\WebServerInstance.ps1' 'C:\NAVDVD\WebClient\Microsoft Dynamics NAV\100\Web Client\bin\'
#& 'C:\install\nav\scripts\Install-Msi.ps1' -MsiFullPath 'C:\NAVDVD\WebClient\Microsoft Dynamics NAV Web Client.msi'
...
Start-Process "C:\\install\\nav\\bin\\ServiceMonitor.exe" -ArgumentList "w3svc" -Wait
